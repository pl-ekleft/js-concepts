...
const newFun = person.logInfo.bind(lena) // первый параметр в bind это контект, который привязан к новой функции
...
// function multBy(arr, n) { // функцию нужно импортировать и после передавать туда параметры (arr, n)
//   return arr.map((i) => {
//     return i * n
//   })
// }
